"""
Django settings for tverdoepravo project.
...
SECRET_KEY = 'django-insecure-fqizj+!0!+^l4o1yjvqe=bt0p-%*#4$rnar1p^j%tim*n^pj@4'
...
ALLOWED_HOSTS = ['tverdoepravo.site', '127.0.0.1', 'eeeexperiment.ru', 'lpy-15.ru', 'tverdoepravo.ru', 'lpy-15-reg.ru', '94.198.216.61', '192.168.0.103', 'lpy-15-reg2.ru', 'tverdoepravo.ru']
...
ROOT_URLCONF = 'tverdoepravo.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main_page.context_processors.global_settings',
            ],
        },
    },
]

WSGI_APPLICATION = 'tverdoepravo.wsgi.application'
